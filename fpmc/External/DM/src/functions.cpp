...
double ReF1(double  Q2, double m , double Lamb){
  double z; double b2; 
    z = Q2/ (4* m*m); 
    b2 =  1 - 1/z ;
   return (0.5-b2/6.)*(ReB(z)-1.)+1./18.+2./6.*log(m/Lamb);
};
double ImF1(double  Q2, double m , double Lamb){
  double z; double b2; 
    z = Q2/ (4* m*m); 
    b2 = 1 - 1/z ;
   return (0.5-b2/6.)*ImB(z);
};
...
double ReF2(double  Q2, double m , double Lamb){
  double z; double b2; 
    z = Q2/ (4* m*m); 
    b2 = 1 - 1/z;
   return (1./8.-b2/12.+b2*b2/40.)*(ReB(z)-1.)+41./1800.-b2/120.+2./30.*log(m/Lamb);
};
double ImF2(double  Q2, double m , double Lamb){
  double z; double b2; 
    z = Q2/ (4* m*m); 
    b2 =  1 - 1/z ;
   return (1./8.-b2/12.+b2*b2/40.)*ImB(z);
};
